...
title: The loop
nav: 3
description: Design, check, complete — the feature loop, walked end to end.
---
...
trace in the card — **accepted drift is documented drift**. The failure
...
1. Regenerate the map — mechanical, so just done.
...
why), and the code — reviewable together.
