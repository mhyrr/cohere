...
title: Intent cards
nav: 5
description: The authored layer of purpose, invariants, and decisions, hash-bound to the code so drift fails the build.
---
...
`mix cohere.check` fails the build with an exact delta:
